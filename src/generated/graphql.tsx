...
export type RegularFieldErrorFragment = { __typename?: "FieldError" } & Pick<
  FieldError,
  "field" | "message"
>;

export type RegularQuackFragment = { __typename?: "Quack" } & Pick<
  Quack,
  | "id"
  | "createdAt"
  | "text"
  ...
  | "likeStatus"
> & {
    quackedByUser: { __typename?: "User" } & RegularUserFragment;
    inReplyToQuack?: Maybe<
      { __typename?: "Quack" } & Pick<
        Quack,
        | "id"
        | "createdAt"
        | "text"
      ...
      > & {
          quackedByUser: { __typename?: "User" } & RegularUserFragment;
          replies?: Maybe<Array<{ __typename?: "Quack" } & Pick<Quack, "id">>>;
          requacks?: Maybe<
            Array<{ __typename?: "Requack" } & Pick<Requack, "id">>
          >;
          likes?: Maybe<Array<{ __typename?: "Like" } & Pick<Like, "id">>>;
        }
    >;
    replies?: Maybe<Array<{ __typename?: "Quack" } & Pick<Quack, "id">>>;
    requacks?: Maybe<Array<{ __typename?: "Requack" } & Pick<Requack, "id">>>;
    likes?: Maybe<Array<{ __typename?: "Like" } & Pick<Like, "id">>>;
  };
...
> & {
    followers?: Maybe<
      Array<
        { __typename?: "User" } & Pick<
          User,
          "id" | "displayName" | "username" | "emailVerified" | "displayPicture"
        >
      >
    >;
    followings?: Maybe<
    ...
    quacks?: Maybe<
      Array<
        { __typename?: "Quack" } & Pick<
          Quack,
          "id" | "text" | "truncatedText" | "urls" | "isVisible"
        > & {
            likes?: Maybe<Array<{ __typename?: "Like" } & Pick<Like, "id">>>;
            requacks?: Maybe<
              Array<{ __typename?: "Requack" } & Pick<Requack, "id">>
            >;
            replies?: Maybe<
              Array<{ __typename?: "Quack" } & Pick<Quack, "id">>
            >;
          }
      >
    >;
...
export type RegularUserResponseFragment = {
  __typename?: "UserResponse";
    ...
    errors?: Maybe<
      Array<{ __typename?: "FieldError" } & RegularFieldErrorFragment>
    >;
  };
...
export type QuackMutation = { __typename?: "Mutation" } & {
  quack: { __typename?: "QuackResponse" } & {
    quack?: Maybe<{ __typename?: "Quack" } & RegularQuackFragment>;
    errors?: Maybe<
      Array<{ __typename?: "FieldError" } & RegularFieldErrorFragment>
    >;
  };
...
export type SignupMutation = { __typename?: "Mutation" } & {
  signup: { __typename?: "UserResponse" } & RegularUserResponseFragment;
};
...
export type UserByEmailQuery = { __typename?: "Query" } & {
  userByEmail?: Maybe<{ __typename?: "User" } & RegularUserFragment>;
};
...
export type UserByIdQuery = { __typename?: "Query" } & {
  userById?: Maybe<{ __typename?: "User" } & RegularUserFragment>;
};
...
export type UserByUsernameQuery = { __typename?: "Query" } & {
  userByUsername?: Maybe<{ __typename?: "User" } & RegularUserFragment>;
};
...
export function useUserByEmailQuery(
  ...
  return Urql.useQuery<UserByEmailQuery>({
...
export function useUserByUsernameQuery(
  options: Omit<Urql.UseQueryArgs<UserByUsernameQueryVariables>, "query"> = {}
) {
  return Urql.useQuery<UserByUsernameQuery>({
